...
replacement_headers = {
    ...
    "RUSAGE_THREAD":"#define _GNU_SOURCE\n#include <sys/resource.h>\n",
...
custom = {
    ...
    "open": {
        "args": {
            "oflag": ["O_RSYNC", "O_WRONLY", "O_DIRECT", "O_DIRECTORY", "O_SYNC", "O_DSYNC", "O_RDONLY", "O_CREAT", "O_TRUNC", "O_RDWR", "O_CLOEXEC", "O_NOFOLLOW", "O_APPEND", "O_LARGEFILE", "O_ASYNC", "O_NDELAY", "O_TMPFILE", "O_NOATIME", "O_EXCL", "O_PATH", "O_NONBLOCK", "O_NOCTTY"],
            "mode":["S_IRWXU", "S_IRWXG", "S_IROTH", "S_IWOTH", "S_IXGRP", "S_ISGID", "S_IWUSR", "S_ISUID", "S_IWGRP", "S_ISVTX", "S_IXUSR", "S_IRWXO", "S_IRUSR", "S_IXOTH", "S_IRGRP"]
        },
